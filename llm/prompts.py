# prompts.py — Simple single prompt section
from dataclasses import dataclass


@dataclass
class AnalystPrompts:
    analyst_prompt: str = """When input exceeds 6000 tokens, process in independent chunks. Do not reference content outside the current chunk.
...
Respond only in JSON. If you cannot find any features, respond [].
